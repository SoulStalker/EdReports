...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token пользователя
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IsAdminRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User_         int64                  `protobuf:"varint,1,opt,name=user_,json=user,proto3" json:"user_,omitempty"` // ID пользователя
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsAdminRequest) GetUser_() int64 {
	if x != nil {
		return x.User_
	}
	return 0
...
type IsAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsAdmin       bool                   `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // админ или нет
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_as_as_proto_rawDesc = "" +
	"\n" +
	"\vas/as.proto\x12\x04auth\"C\n" +
	...
	"\x0eIsAdminRequest\x12\x13\n" +
	"\x05user_\x18\x01 \x01(\x03R\x04user\",\n" +
	"\x0fIsAdminResponse\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xab\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x12Z\x10almaz.as.v1;asv1b\x06proto3"

var (
	file_as_as_proto_rawDescOnce sync.Once
	file_as_as_proto_rawDescData []byte
)

func file_as_as_proto_rawDescGZIP() []byte {
	file_as_as_proto_rawDescOnce.Do(func() {
		file_as_as_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_as_as_proto_rawDesc), len(file_as_as_proto_rawDesc)))
	})
	return file_as_as_proto_rawDescData
}

var file_as_as_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_as_as_proto_goTypes = []any{
...
func file_as_as_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_as_as_proto_rawDesc), len(file_as_as_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
